...
AddDeviceCommand::AddDeviceCommand(DevicesGrid* grid, const Device& device, int index)
    : QUndoCommand(QCoreApplication::translate("DeviceCommands", "Add Device")),
      m_grid(grid),
      m_device(device),
      m_index(index) {}
...
RemoveDeviceCommand::RemoveDeviceCommand(DevicesGrid* grid, const Device& device, int index)
    : QUndoCommand(QCoreApplication::translate("DeviceCommands", "Remove Device")),
      m_grid(grid),
      m_device(device),
      m_index(index) {}
...
UpdateDeviceCommand::UpdateDeviceCommand(DevicesGrid* grid, const Device& fromDevice,
                                         const Device& toDevice)
    : QUndoCommand(QCoreApplication::translate("DeviceCommands", "Edit Device")),
      m_grid(grid),
