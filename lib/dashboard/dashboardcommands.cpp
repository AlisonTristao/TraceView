...
AddWidgetCommand::AddWidgetCommand(DashboardGrid* grid, const DashboardItem& item)
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Add Widget")),
      m_grid(grid),
      m_item(item) {}
...
RemoveWidgetCommand::RemoveWidgetCommand(DashboardGrid* grid, const DashboardItem& item)
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Remove Widget")),
      m_grid(grid),
      m_item(item) {}
...
RemoveWidgetsCommand::RemoveWidgetsCommand(DashboardGrid* grid, const QVector<DashboardItem>& items)
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Remove Widgets")),
      m_grid(grid),
      m_items(items) {}
...
RenameWidgetCommand::RenameWidgetCommand(DashboardGrid* grid, const QString& itemId,
    ...
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Rename Widget")),
      m_grid(grid),
      m_itemId(itemId),
      m_fromName(fromName),
      m_toName(toName) {}
...
SetItemKeyCommand::SetItemKeyCommand(DashboardGrid* grid, const QString& itemId,
                                     const QString& fromKey, const QString& toKey)
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Set Widget Key")),
      m_grid(grid),
      m_itemId(itemId),
      m_fromKey(fromKey),
      m_toKey(toKey) {}
...
SetItemConfigCommand::SetItemConfigCommand(DashboardGrid* grid, const QString& itemId,
                                           const QJsonObject& fromConfig,
                                           const QJsonObject& toConfig)
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Set Widget Config")),
      m_grid(grid),
      m_itemId(itemId),
...
ChangeWidgetTypeCommand::ChangeWidgetTypeCommand(DashboardGrid* grid, const QString& itemId,
    ...
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Change Widget Type")),
      m_grid(grid),
      m_itemId(itemId),
      m_fromTypeId(fromTypeId),
      m_toTypeId(toTypeId) {}
...
ChangeZOrderCommand::ChangeZOrderCommand(DashboardGrid* grid, const QString& itemId, int fromIndex,
                                         int toIndex, const QString& label)
    : QUndoCommand(label),
      m_grid(grid),
      m_itemId(itemId),
...
GroupItemsCommand::GroupItemsCommand(DashboardGrid* grid,
                                     const QMap<QString, QString>& previousGroupIds,
                                     const QString& newGroupId)
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Group Widgets")),
      m_grid(grid),
...
UngroupItemsCommand::UngroupItemsCommand(DashboardGrid* grid,
                                         const QMap<QString, QString>& previousGroupIds)
    : QUndoCommand(QCoreApplication::translate("DashboardCommands", "Ungroup Widgets")),
      m_grid(grid),
      m_previousGroupIds(previousGroupIds) {}
